...
void RelaySession::Register()
{
	...
	#if 1
		qtss_fprintf(stderr,"=========================>>>>sRelayName %u \n",sRelayName);
	#endif
    ...
    #if 1
		qtss_fprintf(stderr,"=========================>>>>sSourceType %u \n",sSourceType);
	#endif
	...
	#if 1
		qtss_fprintf(stderr,"=========================>>>>sSourceIPAddr %u \n",sSourceIPAddr);
	...
	#if 1
		qtss_fprintf(stderr,"=========================>>>>sSourceInIPAddr %u \n",sSourceInIPAddr);
	...
	#if 1
		qtss_fprintf(stderr,"=========================>>>>sSourceUDPPorts %u \n",sSourceUDPPorts);
    ...
    (void)QTSS_IDForAttr(qtssRelaySessionObjectType, sSourceRTSPPortName, &sSourceRTSPPort);        // rtsp port
 	#if 1
		qtss_fprintf(stderr,"=========================>>>>sSourceRTSPPort %u \n",sSourceRTSPPort);
	...
	#if 1
		qtss_fprintf(stderr,"=========================>>>>sSourceURL %u \n",sSourceURL);
...
void RelaySession::Initialize(QTSS_Object inRelayModuleAttributesObject)
{
    ...
    if (inRelayModuleAttributesObject != NULL){
        ...
        sRelaySessionObjectID = QTSSModuleUtils::CreateAttribute(inRelayModuleAttributesObject, 
        															sRelaySessionObjectName, 
