    ...
    fRTSPOutputInfo(NULL)
{
	...
	// 拷贝 RelaySession 中的每个 ReflectorStream 到当前RelayOutput 
	...
	/////////////////////////////////////////////////////////////////////////////////////////////
	//
	//  每个RelayOutput都有推送功能，因此都必须具备客户端功能。(重要。详细查看开发手册 自动播送)
	//
	/////////////////////////////////////////////////////////////////////////////////////////////
    if (isRTSPSourceInfo){
...
OS_Error RelayOutput::BindSocket()
{
    ...
    theErr = fOutputSocket.Bind(fOutputInfo.fLocalAddr, 0/* 由系统随之指定端口 */);
    if (theErr != OS_NoErr){
        return theErr;
	}
