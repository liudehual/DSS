...
#define ADMINCLASS_DEBUG 0


#define MEMORYDEBUGGING 1
#if MEMORYDEBUGGING
...
{   
	...
	***************************************************************************/
...
#if ADMINCLASS_DEBUG
	qtss_printf("1.=====>>> currentPathPtr %s \n",currentPathPtr->Ptr);
#endif
    ...
    {   
		...
		ElementNode_InsertPtr(fElementMap,"AdminClass::Initialize ElementNode* fElementMap ");
        Assert(fElementMap != NULL);
        if (fElementMap == NULL){ 
			break;
		}
		...
		ElementNode_InsertPtr(fFieldDataPtrs,"AdminClass::Initialize ElementNode* fFieldDataPtrs array ");
        Assert(fFieldDataPtrs != NULL);
        if (fFieldDataPtrs == NULL){ 
			break;
		}
        memset(fFieldDataPtrs, 0, numFields * sizeof(char*));
		...
		ElementNode_InsertPtr(fFieldOSRefPtrs,"AdminClass::Initialize ElementNode* fFieldOSRefPtrs array ");
        Assert(fFieldOSRefPtrs != NULL);
		
        if (fFieldOSRefPtrs == NULL){ 
			break;
		}
        memset(fFieldOSRefPtrs, 0, numFields * sizeof(OSRef*));
