...
SInt64 RTPSession::Run()
{
    ...
    */ 
    ...
    //RTSP requests coming in while it's sending packets
    {
		...
		/*
			计算下一次发送数据的时间间隔(ReflectorModule 返回0)
		*/
		...
		*/
        ...
        {           
    		...
    		(void)fModule->GetValueAsString (qtssModName, 0, &moduleName);
      		/* 调用模块的发送角色，开始发送RTP数据包 */
